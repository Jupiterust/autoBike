...
#define OLED_W_D0(x)         sys_gpio_pin_set(GPIOA, SYS_GPIO_PIN5, x);
#define OLED_W_D1(x)         sys_gpio_pin_set(GPIOA, SYS_GPIO_PIN7, x);
#define OLED_W_RES(x)        sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN0, x);
#define OLED_W_DC(x)         sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN1, x); 
#define OLED_W_CS(x)         sys_gpio_pin_set(GPIOA, SYS_GPIO_PIN4, x); 
//   #define OLED_W_D0(x)         sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN5, x);
//#define OLED_W_D1(x)         sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN4, x);
//#define OLED_W_RES(x)        sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN3, x);
//#define OLED_W_DC(x)         sys_gpio_pin_set(GPIOA, SYS_GPIO_PIN15, x); 
//#define OLED_W_CS(x)         sys_gpio_pin_set(GPIOA, SYS_GPIO_PIN12, x); 
#endif
...
void OLED_GPIO_Init(void)
{
   ...
   sys_gpio_set(GPIOA, SYS_GPIO_PIN4 | SYS_GPIO_PIN5 |SYS_GPIO_PIN7,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* LED0引脚模式设置 */

    
   RCC->APB2ENR |= 1 << 3;/* GPIOB时钟使能 */
   sys_gpio_set(GPIOB, SYS_GPIO_PIN0 | SYS_GPIO_PIN1,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* LED0引脚模式设置 */
//         RCC->APB2ENR |= 1 << 2;/* GPIOA时钟使能 */
