#ifndef __A_include_H
#define __A_include_H
...
#define KEY_0 	    PBin(2)   
#define LED0        PEout(11)	
#define LED1        PFout(14)	
#define BEEP_ON     __HAL_TIM_SetCompare(&htim12, TIM_CHANNEL_1, 300);
#define BEEP_OFF    __HAL_TIM_SetCompare(&htim12, TIM_CHANNEL_1, 0);
